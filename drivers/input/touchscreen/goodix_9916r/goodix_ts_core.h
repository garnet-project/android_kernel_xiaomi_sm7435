...
#define GAME_CORNER_SUPPRESSION_MEDIUM 180
#define GAME_CORNER_SUPPRESSION_LARGE 280
/*竖屏游戏*/
#define VERTICAL_GAME_CORNER_SUPPRESSION_Y 300
#define VERTICAL_GAME_CORNER_SUPPRESSION_X 150
/* conrner suppression case2 */
#define GAME_CORNER_SUPPRESSION_HOR 150
#define GAME_CORNER_SUPPRESSION_VER 150
